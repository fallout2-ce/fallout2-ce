...
static void _print_tohit(unsigned char* dest, int destPitch, int accuracy)
{
    ...
    int numbersFid = buildFid(OBJ_TYPE_INTERFACE, 82, 0, 0);
...
static int calledShotSelectHitLocation(Object* critter, HitLocation* hitLocation, HitMode hitMode)
{
    *hitLocation = HIT_LOCATION_TORSO;
    ...
    int backgroundFid = buildFid(OBJ_TYPE_INTERFACE, 118, 0, 0);
    ...
    FrmImage critterFrm;
    int critterFid = buildFid(OBJ_TYPE_CRITTER, critter->fid & 0xFFF, ANIM_CALLED_SHOT_PIC, 0);
    ...
    int cancelButtonNormalFid = buildFid(OBJ_TYPE_INTERFACE, 8, 0, 0);
    ...
    int cancelButtonPressedFid = buildFid(OBJ_TYPE_INTERFACE, 9, 0, 0);
