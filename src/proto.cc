...
int proto_save_text(int pid)
{
    ...
    case OBJ_TYPE_ITEM:
        ...
        case ITEM_TYPE_WEAPON:
            ...
            filePrintFormatted(stream, "d.caliber: %s\n", gCaliberTypeNames[proto->item.data.weapon.caliber]);
            ...
            break;
        case ITEM_TYPE_AMMO:
            filePrintFormatted(stream, "d.caliber: %s\n", gCaliberTypeNames[proto->item.data.ammo.caliber]);
    ...
    case OBJ_TYPE_CRITTER:
        ...
        filePrintFormatted(stream, "d.body: %d %s\n", proto->critter.data.bodyType, gBodyTypeNames[proto->critter.data.bodyType]);
