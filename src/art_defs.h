...
enum class InterfaceFrameId : int {
    ...
    Egg = 2, // egg.rm - used for the translucent "egg" effect around player
    ...
    INTF_FRM_ID_87 = 87, // di_bgup1.frm - dialog big down arrow <UP>
    INTF_FRM_ID_88 = 88, // di_bgup2.frm - dialog big down arrow <DOWN>
    INTF_FRM_ID_89 = 89, // di_bgdn1.frm - dialog big up arrow <UP>
    INTF_FRM_ID_90 = 90, // di_bgdn2.frm - dialog big up arrow <DOWN>
    ...
    INTF_FRM_ID_102 = 102, // review.frm - dialog review background
