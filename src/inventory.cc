...
#define INVENTORY_NORMAL_BACKGROUND_FRM_ID static_cast<ObjectFrameId>(48)
#define INVENTORY_LOOT_BACKGROUND_FRM_ID static_cast<ObjectFrameId>(114)
#define INVENTORY_TRADE_WINDOW_WIDTH 480
...
static bool inventoryBackgroundLoad(FrmImage& image, ObjectFrameId col1FrmId, const char* col2Name, int columns);
static int inventoryChooseColumns(FrmImage& image, int expandedWidth, ObjectFrameId col1FrmId, const char* col2Name);
...
// 0x46E708
static const ObjectFrameId gInventoryArrowFrmIds[INVENTORY_ARROW_FRM_COUNT] = {
    static_cast<ObjectFrameId>(122), // left arrow up
    static_cast<ObjectFrameId>(123), // left arrow down
    static_cast<ObjectFrameId>(124), // right arrow up
    static_cast<ObjectFrameId>(125), // right arrow down
};
...
static const InventoryWindowDescription gInventoryWindowDescriptions[INVENTORY_WINDOW_TYPE_COUNT] = {
    ...
    { static_cast<ObjectFrameId>(113), INVENTORY_USE_ON_WINDOW_WIDTH, 376, 80, 0 },
    { INVENTORY_LOOT_BACKGROUND_FRM_ID, INVENTORY_LOOT_WINDOW_WIDTH, 376, 80, 0 },
    { static_cast<ObjectFrameId>(111), INVENTORY_TRADE_WINDOW_WIDTH, 180, 80, 290 },
    { static_cast<ObjectFrameId>(305), INVENTORY_TIMER_WINDOW_WIDTH, 162, 140, 80 },
    { static_cast<ObjectFrameId>(305), INVENTORY_TIMER_WINDOW_WIDTH, 162, 140, 80 },
};
...
// 0x5190FC num
static const ObjectFrameId gInventoryWindowCursorFrmIds[INVENTORY_WINDOW_CURSOR_COUNT] = {
    static_cast<ObjectFrameId>(286), // pointing hand
    static_cast<ObjectFrameId>(250), // action arrow
    static_cast<ObjectFrameId>(282), // action pick
    static_cast<ObjectFrameId>(283), // action menu
    static_cast<ObjectFrameId>(266), // blank
};
...
static ConstBuffer2D inventoryGetBackgroundBuffer(int inventoryWindowType, ObjectFrameId fallbackFrmId, FrmImage& fallbackImage, int& sourceXOffset)
{
    sourceXOffset = 0;
...
int inventoryComputeCritterFid(Object* critter, int basePid, Object* rightHandItem, Object* leftHandItem, Object* armor, Hand activeHand, AnimationType anim, Rotation rotation)
{
    ...
    ObjectFrameId inventoryFid = _art_vault_guy_num;
...
static bool _setup_inventory(int inventoryWindowType)
{
    ...
    if (doneButtonXY.first != -1) {
        buttonCreateActionWithFrm(gInventoryWindow,
            ...
            -1, KEY_ESCAPE,
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(8)),
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(9)));
    }
    ...
    if (inventoryWindowType == INVENTORY_WINDOW_TYPE_TRADE) {
        ...
        buttonCreateActionWithFrm(gInventoryWindow,
            109, 56,
            KEY_ARROW_UP, -1,
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(100)),
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(101)));
        ...
        gInventoryScrollUpButton = buttonCreateActionWithFrm(gInventoryWindow,
            scrollUpX, 39,
            KEY_ARROW_UP, -1,
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(49)),
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(50)));
        if (gInventoryScrollUpButton != -1) {
            buttonSetDisabledFrm(gInventoryScrollUpButton,
                FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(53)),
                FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(53)),
                FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(53)));
    ...
    if (inventoryWindowType == INVENTORY_WINDOW_TYPE_TRADE) {
        ...
        buttonCreateActionWithFrm(gInventoryWindow,
            109, 82,
            KEY_ARROW_DOWN, -1,
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(93)),
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(94)));
        ...
        gInventoryScrollDownButton = buttonCreateActionWithFrm(gInventoryWindow,
            scrollDownX, 62,
            KEY_ARROW_DOWN, -1,
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(51)),
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(52)));
        if (gInventoryScrollDownButton != -1) {
            buttonSetDisabledFrm(gInventoryScrollDownButton,
                FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(54)),
                FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(54)),
                FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(54)));
        ...
        if (inventoryWindowType == INVENTORY_WINDOW_TYPE_LOOT) {
            ...
            gSecondaryInventoryScrollDownButton = buttonCreateActionWithFrm(gInventoryWindow,
                ...
                KEY_CTRL_ARROW_DOWN, -1,
                FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(51)), FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(52)));
            if (gSecondaryInventoryScrollDownButton != -1) {
                buttonSetDisabledFrm(gSecondaryInventoryScrollDownButton,
                    FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(54)), FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(54)), FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(54)));
    ...
    if (inventoryWindowType != INVENTORY_WINDOW_TYPE_TRADE) {
        if (inventoryWindowType == INVENTORY_WINDOW_TYPE_LOOT) {
            if (!_gIsSteal) {
                ...
                buttonCreateActionWithFrm(gInventoryWindow,
                    ...
                    FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(436)), FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(437)));
            }
        }
    } else {
        ...
        buttonCreateActionWithFrm(gInventoryWindow,
            ...
            FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(49)), FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(50)));
...
static void _display_body(int fid, int inventoryWindowType)
{
    ...
    for (int index = 0; index < 2; index += 1) {
        ...
        if (inventoryWindowType == INVENTORY_WINDOW_TYPE_TRADE) {
            ...
            FrmImage backgroundFrmImage;
            int backgroundFid = buildFid(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(gGameDialogSpeakerIsPartyMember ? 420 : 111));
            if (backgroundFrmImage.lock(backgroundFid)) {
            ...
            FrmImage backgroundFrmImage;
            ObjectFrameId Fid = INVENTORY_LOOT_BACKGROUND_FRM_ID;
            int sourceXOffset = 0;
            ...
            if (index == 1) {
                ...
                if (inventoryWindowType == INVENTORY_WINDOW_TYPE_LOOT) {
                    ...
                    rect.top = 37;
                    Fid = static_cast<ObjectFrameId>(113);
                    sourceXOffset = 292;
                } else {
...
int inventoryEquipFunc(Object* critter, Object* item, Hand handIndex, bool animate)
{
    ...
    if (itemType == ITEM_TYPE_ARMOR) {
        ...
        if (baseFrmId == OBJECT_FRAME_ID_INVALID) {
            baseFrmId = static_cast<ObjectFrameId>(1);
        }
...
static int inventoryQuantityWindowInit(int inventoryWindowType, Object* item)
{
    ...
    int btn = buttonCreateActionWithFrm(_mt_wid,
        x, y, 6000, -1, FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(193)), FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(194)));

    // Minus button
    btn = buttonCreateActionWithFrm(_mt_wid,
        x, y + 12, 7000, -1, FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(191)), FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(192)));

    // Done
    btn = buttonCreateActionWithFrm(_mt_wid,
        98, 128, -1, 500, FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(8)), FrmId(OBJ_TYPE_INTERFACE, static_cast<ObjectFrameId>(9)));
