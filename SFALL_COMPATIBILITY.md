...
| Setting | ddraw.ini section | ddraw.ini key | fallout2.cfg section | fallout2.cfg key |
| --- | --- | --- | --- | --- |
| Skip opening movies | `Misc` | `SkipOpeningMovies` | `ui` | `skip_opening_movies` |
| Display karma changes | `Misc` | `DisplayKarmaChanges` | `ui` | `display_karma_changes` |
| Display bonus damage | `Misc` | `DisplayBonusDamage` | `ui` | `display_bonus_damage` |
| Numbers in dialogue | `Misc` | `NumbersInDialogue` | `ui` | `numbers_in_dialogue` |
| Auto quick save | `Misc` | `AutoQuickSave` | `ui` | `auto_quick_save` |
| Enable high resolution stencil | `Main` | `EnableHighResolutionStencil` | `ui` | `enable_high_resolution_stencil` |
| Console output path | `Misc` | `ConsoleOutputPath` | `debug` | `console_output_path` |
| Gapless music | `Misc` | `GaplessMusic` | `sound` | `gapless_music` |
| Screenshots format | `Misc` | `ScreenshotsFormat` | `system` | `screenshots_format` |
| Use walk distance | `Misc` | `UseWalkDistance` | `qol` | `use_walk_distance` |
| Auto open doors | `Misc` | `AutoOpenDoors` | `qol` | `auto_open_doors` |
